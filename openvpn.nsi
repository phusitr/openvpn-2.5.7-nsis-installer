...
;Configuration
  ...
  OutFile "NECTEC-Openvpn-${OPENVPN_VERSION}-client-install-x64.exe"
  SetCompressor lzma
...
;Modern UI Configuration
  ...
  !define MUI_WELCOMEPAGE_TITLE "Welcome to the ${PRODUCT_NAME} Setup. Installer build by TSS, NECTEC"
  !define MUI_WELCOMEPAGE_TEXT "OpenVPN -  an Open Source VPN package by James Yonan.\r\n\r\nOpenVPN GUI v11.10 Icons - Created by Matthew Marable\r\n\r\nCustom Installer Created by Thaisarn, TSS, NECTEC"
  !define MUI_COMPONENTSPAGE_TEXT_TOP "Virtual Private Network for NHIS Project, Bangkok v2.0"
...
Section "Desktop Shortcut" SectionShotcut
    SetShellVarContext current
    CreateShortCut "$DESKTOP\vpnmonitor.lnk" "$INSTDIR\bin\vpnmonitor.html"
SectionEnd
